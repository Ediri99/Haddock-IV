...
public class SellerOrderManagement extends AppCompatActivity{
    ...
    EditText name_item_order,quantity_order,price_order,s_name, s_phone, s_address, s_description, s_payment, totalAmount;
    Button confirm_order_btn,edit_order_btn,delete_order_btn,calculation_btn;
    ...
    public void updateOrderSeller(String customerName,String phoneNumber, String homeAddress,String description, String paymentMethod, String itemName, String itemQuantity,String itemPrice, String totalAmount ){

        bdref = FirebaseDatabase.getInstance().getReference().child("SellerOrder").child(phoneNumber);

        SellerOrder sellerorder = new SellerOrder(customerName, phoneNumber, homeAddress, description, paymentMethod,itemName,itemQuantity,itemPrice,totalAmount);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calculation_btn = (Button) findViewById(R.id.calculation_btn);
        ...
        LoadingDialog loadingDialog = new LoadingDialog(SellerOrderManagement.this);
        ...
        confirm_order_btn.setOnClickListener(view -> {
            ...
            if (TextUtils.isEmpty(s_name.getText().toString()))
                ...
                sellerorder.setOrderTotal(totalAmount.getText().toString().trim());
                String totalAmount = sellerorder.getOrderTotal();
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(SellerOrderManagement.this, "Order Submitted Successfully.", Toast.LENGTH_SHORT).show();
...
//end loading animation
        ...
        edit_order_btn.setOnClickListener(view ->{
            ...
            updateOrderSeller(customerName,phoneNumber, homeAddress, description, paymentMethod,itemName,itemQuantity,itemPrice,totalAmount);
        ...
        calculation_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Integer qty = Integer.parseInt(quantity_order.getText().toString());
                Integer pr = Integer.parseInt(price_order.getText().toString());
